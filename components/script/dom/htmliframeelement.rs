...
impl HTMLIFrameElement {
    ...
    fn process_the_iframe_attributes(&self, mode: ProcessingMode, can_gc: CanGc) {
        ...
        // Note: despite not being explicitly state in the spec steps, this fall back to document's
        // referrer policy here because it satisfies the expectations that when unset, the iframe
        // should inherit the referrer policy of its parent
