...
use script_traits::{
    ConstellationControlMsg, DocumentState, IFrameSizeMsg, LoadData, LoadOrigin,
    NavigationHistoryBehavior, ScriptMsg, ScriptToConstellationChan, ScrollState,
    StructuredSerializedData, Theme, TimerSchedulerMsg, WindowSizeData, WindowSizeType,
};
    ...
    pub fn load_url(
        ...
        if doc.prompt_to_unload(false, can_gc) {
            ...
            let resolved_history_handling = if history_handling == NavigationHistoryBehavior::Auto {
                ...
                // Note: `targetNavigable` is not actually defined in the spec, source_document is
                // assumed
