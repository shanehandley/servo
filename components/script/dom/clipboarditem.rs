 ...
 * file, You can obtain one at https://mozilla.org/MPL/2.0/. */
 ...
 use crate::dom::bindings::codegen::Bindings::ClipboardItemBinding::{ClipboardItemMethods, ClipboardItemOptions, PresentationStyle};
 ...
 impl ClipboardItem {
     ...
     pub fn Constructor(
         ...
         _unknown: Record<DOMString, Rc<Promise>>,
