...
impl ScriptThread {
    ...
    fn load(
        ...
        // Step 16.1 of https://html.spec.whatwg.org/multipage/#creating-a-new-browsing-context
        // When determining the document referrer, when the creator is non-null, set document's
